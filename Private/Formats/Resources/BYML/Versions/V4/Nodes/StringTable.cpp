...
namespace Formats::Resources::BYML::Versions::V4::Nodes {
	StringTable::StringTable(Formats::Resources::BYML::Versions::V4::V4* parentBYML) : Formats::Resources::BYML::Versions::V4::Node::Node(parentBYML) {
	...
	bool StringTable::Parse(Formats::IO::BinaryIOStream& bStream) {
		...
		if (bStream.ReadU8() != Formats::Resources::BYML::Versions::V4::NodeType::StringTable)
			return false;
	...
	bool StringTable::Serialize(Formats::IO::BinaryIOStream& bStream) {
		bStream.WriteS8(Formats::Resources::BYML::Versions::V4::NodeType::StringTable);
