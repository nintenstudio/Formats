...
#define FORMATS_IO_BINARYIOSTREAM_READ_STRING_DEFAULTALLOCATION 32
...
namespace Formats::IO {
	...
	public:
		...
		virtual std::string ReadZeroTerminatedString(F_U32 allocation = FORMATS_IO_BINARYIOSTREAM_READ_STRING_DEFAULTALLOCATION) = 0;
