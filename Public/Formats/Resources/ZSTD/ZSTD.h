...
namespace Formats::Resources::ZSTD {
	...
	public:
		static std::shared_ptr<ZSTD> Factory(std::shared_ptr<Formats::IO::BinaryIOStreamBasic> stream) {
		...
		ZSTD(std::shared_ptr<Formats::IO::BinaryIOStreamBasic> stream) : Formats::Resource(stream) {
